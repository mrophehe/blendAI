...
OPENROUTER_API_KEY = "Place_OPENROUTER_API_KEY_HERE"
MODEL_NAME = "nvidia/llama-3.1-nemotron-70b-instruct:free"    #can use any free models/ even paid models here -> preffered: Gemini 2.5 pro experimental/ Claude Sonnet 3.7
